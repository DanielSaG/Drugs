 ...
 */
@Data
@ApiModel(description="Modelo de respuesta de la API de Medicamentos")
public class DrugResponse implements Serializable{
    ...
    @ApiModelProperty(required = true,example = "15", notes="Id del medicament")
    private long id;
    @ApiModelProperty(required = true,example = "12", notes="Nombre del medicamento")
    ...
    @ApiModelProperty(required = false,example = "vantal", notes="Unicamente se usa cuando se agregan elemntos al inventario. Id de la sucursal al que pertenecen")
    ...
    @ApiModelProperty(required = true,notes="Un solo valor de los indicados",example = "SOLUTION", allowableValues = "PASTILLA,CAPSULA,POMADA,PASTA,CREMA,SOLUCION,ENYECCION,JARABE,OXIGENO,LOCION,AEROSOL")
